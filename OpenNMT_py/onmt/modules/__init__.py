...
from onmt.modules.AdaSoftmaxGenerator import AdaSoftmaxGenerator, NMTLossComputeBeta
...
__all__ = ["Elementwise", "context_gate_factory", "ContextGate",
           ...
           "WeightNormConv2d", "AverageAttention","AdaSoftmaxGenerator","NMTLossComputeBeta"]
