...
def model_opts(parser):
    ...
    group.add('--adasoftmax', '-adasoftmax', action="store_true",
              help='generator with adasoftmax')

    group.add_argument('--tgt_vocab_cutoff', '-tgt_vocab_cutoff', default=[], nargs='+', type=int,
                       help="Cutoff sizes of the target vocabulary for AdaSoftmax")
...
def translate_opts(parser):
    ...
    group.add('--trans_to', '-trans_to', type=str, default="",
              help="The traget language translate to")
